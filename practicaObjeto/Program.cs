...
namespace PrácticaObjetos
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Telefono Casa: " + contacto1.TelefonoCasa);

            Contacto contacto2 = new Contacto("Juan Perez");
            Console.WriteLine("Contacto 2");
            Console.WriteLine("Nombre: " + contacto2.Nombre);

            Contacto contacto3 = new Contacto("Maria Navarro", "123456789", "987654321", "5 de febrero 895", "maria@correo.com");
